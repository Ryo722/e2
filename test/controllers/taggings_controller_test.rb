...
class TaggingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tagging" do
    assert_difference('Tagging.count') do
      post taggings_url, params: { tagging: { product_id: @tagging.product_id, tag_id: @tagging.tag_id } }
    end
  ...
  test "should update tagging" do
    patch tagging_url(@tagging), params: { tagging: { product_id: @tagging.product_id, tag_id: @tagging.tag_id } }
